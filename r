...
import sources.azure_public
import sources.gcp_public
...
# New Cloud Providers (Same Style)
##sources.azure_public.scrape(
##    out_csv="data/azure_public_prices.csv",
##    out_json="data/azure_public_prices.json"
#)

##sources.gcp_public.scrape(
##    out_csv="data/gcp_public_prices.csv",
##    out_json="data/gcp_public_prices.json"
#)
